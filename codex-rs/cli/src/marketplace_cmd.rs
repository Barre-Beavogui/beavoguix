...
#[derive(Debug, Parser)]
#[command(bin_name = "beavoguix plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "beavoguix plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "beavoguix plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "beavoguix plugin marketplace remove")]
