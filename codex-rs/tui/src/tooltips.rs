...
/// Pick a random tooltip to show to the user when starting Beavoguix.
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Beavoguix TUI.
...
[[announcements]]
content = "Welcome to Beavoguix! Check out the new onboarding flow."
